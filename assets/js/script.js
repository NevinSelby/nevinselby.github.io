...
const knowledgeBase = [
  ...
  { question: "does nevin have experience with game development", answer: "Nevin has not worked on game development projects, but he is familiar with programming concepts that could be applied to game development." },
  { question: "what is nevin's experience with mobile development", answer: "Nevin has not worked on mobile development projects, but he is familiar with JavaScript and could potentially explore mobile development in the future." },
  { question: "does nevin have experience with web development", answer: "Nevin has intermediate experience with JavaScript and has built interactive web applications as part of his projects." },
  { question: "what is nevin's experience with APIs", answer: "Nevin has worked with APIs, including GPT-3.5-Turbo and AWS services, for integrating machine learning models into applications." },
  { question: "does nevin have experience with microservices", answer: "Yes, Nevin has worked with microservices architecture using Docker and Kubernetes for deploying scalable AI solutions." },
  { question: "what is nevin's experience with serverless computing", answer: "Nevin has used AWS Lambda for serverless computing in his machine learning projects." },
  { question: "does nevin have experience with cybersecurity", answer: "Nevin is aware of cybersecurity best practices but has not specialized in this area." },
  { question: "what is nevin's experience with blockchain", answer: "Nevin has not worked on blockchain projects, but he is familiar with the underlying concepts and potential applications." },
  { question: "does nevin have experience with quantum computing", answer: "Nevin has not worked on quantum computing projects, but he is interested in exploring this field in the future." },
  { question: "what is nevin's experience with AR/VR", answer: "Nevin has not worked on AR/VR projects, but he is familiar with the underlying technologies and their potential applications." },
  { question: "does nevin have experience with 3D modeling", answer: "Nevin has not worked on 3D modeling projects, but he is familiar with the concepts and tools used in this field." },
  { question: "what is nevin's experience with GIS", answer: "Nevin has not worked on GIS projects, but he is familiar with geospatial data analysis and its applications." },
  { question: "does nevin have experience with bioinformatics", answer: "Nevin has not worked on bioinformatics projects, but he is interested in exploring this field in the future." },
  { question: "what is nevin's experience with finance", answer: "Nevin has not worked on finance-specific projects, but he is familiar with data analysis techniques that could be applied to financial data." },
  { question: "does nevin have experience with healthcare", answer: "Nevin has not worked on healthcare-specific projects, but he is interested in applying AI to healthcare challenges in the future." },
  { question: "what is nevin's experience with education", answer: "Nevin has shared his knowledge through technical articles on Medium and YouTube videos, demonstrating his passion for education and mentorship." },
  { question: "does nevin have experience with social impact projects", answer: "Nevin has not worked on social impact projects, but he is interested in using AI to address social challenges in the future." },
  { question: "what is nevin's experience with sustainability", answer: "Nevin has not worked on sustainability-specific projects, but he is interested in exploring how AI can contribute to sustainable solutions." },
  { question: "does nevin have experience with climate science", answer: "Nevin has not worked on climate science projects, but he is interested in applying AI to climate-related challenges in the future." },
  { question: "what is nevin's experience with energy", answer: "Nevin has not worked on energy-specific projects, but he is interested in exploring how AI can optimize energy systems." },
  { question: "does nevin have experience with transportation", answer: "Nevin has not worked on transportation-specific projects, but he is interested in applying AI to improve transportation systems." },
  { question: "what is nevin's experience with retail", answer: "Nevin has not worked on retail-specific projects, but he is familiar with data analysis techniques that could be applied to retail data." },
  { question: "does nevin have experience with e-commerce", answer: "Nevin has not worked on e-commerce-specific projects, but he is familiar with data analysis techniques that could be applied to e-commerce data." },
  { question: "what is nevin's experience with marketing", answer: "Nevin has not worked on marketing-specific projects, but he is familiar with data analysis techniques that could be applied to marketing data." },
  { question: "does nevin have experience with sales", answer: "Nevin has not worked on sales-specific projects, but he is familiar with data analysis techniques that could be applied to sales data." },
  { question: "what is nevin's experience with customer service", answer: "Nevin has not worked on customer service-specific projects, but he is familiar with NLP techniques that could be applied to improve customer service." },
  { question: "does nevin have experience with HR", answer: "Nevin has not worked on HR-specific projects, but he is familiar with data analysis techniques that could be applied to HR data." },
  { question: "what is nevin's experience with operations", answer: "Nevin has not worked on operations-specific projects, but he is familiar with data analysis techniques that could be applied to optimize operations." },
  { question: "does nevin have experience with supply chain", answer: "Nevin has not worked on supply chain-specific projects, but he is interested in exploring how AI can optimize supply chain processes." },
  { question: "what is nevin's experience with logistics", answer: "Nevin has not worked on logistics-specific projects, but he is interested in exploring how AI can improve logistics systems." },
  { question: "does nevin have experience with manufacturing", answer: "Nevin has not worked on manufacturing-specific projects, but he is interested in exploring how AI can optimize manufacturing processes." },
  { question: "what is nevin's experience with agriculture", answer: "Nevin has worked on projects involving agricultural data, such as analyzing cranberry growth patterns and optimizing classification models." },
  { question: "does nevin have experience with food tech", answer: "Nevin has not worked on food tech-specific projects, but he is interested in exploring how AI can improve food production and distribution." },
  { question: "what is nevin's experience with fashion", answer: "Nevin has not worked on fashion-specific projects, but he is interested in exploring how AI can optimize fashion design and retail." },
  { question: "does nevin have experience with entertainment", answer: "Nevin has not worked on entertainment-specific projects, but he is interested in exploring how AI can enhance entertainment experiences." },
  { question: "what is nevin's experience with media", answer: "Nevin has not worked on media-specific projects, but he is interested in exploring how AI can improve media production and distribution." },
  { question: "does nevin have experience with journalism", answer: "Nevin has not worked on journalism-specific projects, but he is interested in exploring how AI can assist in news generation and analysis." },
  { question: "what is nevin's experience with publishing", answer: "Nevin has not worked on publishing-specific projects, but he is interested in exploring how AI can optimize publishing workflows." },
  { question: "does nevin have experience with gaming", answer: "Nevin has not worked on gaming-specific projects, but he is interested in exploring how AI can enhance gaming experiences." },
  { question: "what is nevin's experience with sports", answer: "Nevin has not worked on sports-specific projects, but he is interested in exploring how AI can optimize sports performance and analysis." },
  { question: "does nevin have experience with fitness", answer: "Nevin has not worked on fitness-specific projects, but he is interested in exploring how AI can improve fitness tracking and recommendations." },
  { question: "what is nevin's experience with wellness", answer: "Nevin has not worked on wellness-specific projects, but he is interested in exploring how AI can enhance wellness programs and services." },
  { question: "does nevin have experience with mental health", answer: "Nevin has not worked on mental health-specific projects, but he is interested in exploring how AI can assist in mental health support and analysis." },
  { question: "what is nevin's experience with education technology", answer: "Nevin has not worked on education technology-specific projects, but he is interested in exploring how AI can improve learning experiences." },
  { question: "does nevin have experience with edtech", answer: "Nevin has not worked on edtech-specific projects, but he is interested in exploring how AI can enhance educational tools and platforms." },
  { question: "what is nevin's experience with fintech", answer: "Nevin has not worked on fintech-specific projects, but he is interested in exploring how AI can optimize financial services and products." },
  { question: "does nevin have experience with insurtech", answer: "Nevin has not worked on insurtech-specific projects, but he is interested in exploring how AI can improve insurance processes and services." },
  { question: "what is nevin's experience with proptech", answer: "Nevin has not worked on proptech-specific projects, but he is interested in exploring how AI can optimize real estate processes and services." },
  { question: "does nevin have experience with legal tech", answer: "Nevin has not worked on legal tech-specific projects, but he is interested in exploring how AI can assist in legal research and analysis." },
  { question: "what is nevin's experience with govtech", answer: "Nevin has not worked on govtech-specific projects, but he is interested in exploring how AI can improve government services and processes." },
  { question: "does nevin have experience with civic tech", answer: "Nevin has not worked on civic tech-specific projects, but he is interested in exploring how AI can enhance civic engagement and services." },
  { question: "what is nevin's experience with nonprofit", answer: "Nevin has not worked on nonprofit-specific projects, but he is interested in exploring how AI can assist nonprofit organizations in achieving their goals." },
  { question: "does nevin have experience with philanthropy", answer: "Nevin has not worked on philanthropy-specific projects, but he is interested in exploring how AI can optimize philanthropic efforts and impact." },
  { question: "what is nevin's experience with social media", answer: "Nevin has not worked on social media-specific projects, but he is interested in exploring how AI can enhance social media platforms and analytics." },
  { question: "does nevin have experience with influencer marketing", answer: "Nevin has not worked on influencer marketing-specific projects, but he is interested in exploring how AI can optimize influencer campaigns and analytics." },
  { question: "what is nevin's experience with content marketing", answer: "Nevin has not worked on content marketing-specific projects, but he is interested in exploring how AI can improve content creation and distribution." },
  { question: "does nevin have experience with SEO", answer: "Nevin has not worked on SEO-specific projects, but he is interested in exploring how AI can optimize search engine rankings and analytics." },
  { question: "what is nevin's experience with SEM", answer: "Nevin has not worked on SEM-specific projects, but he is interested in exploring how AI can improve search engine marketing campaigns." },
  { question: "does nevin have experience with PPC", answer: "Nevin has not worked on PPC-specific projects, but he is interested in exploring how AI can optimize pay-per-click advertising campaigns." },
  { question: "what is nevin's experience with affiliate marketing", answer: "Nevin has not worked on affiliate marketing-specific projects, but he is interested in exploring how AI can enhance affiliate campaigns and analytics." },
  { question: "does nevin have experience with email marketing", answer: "Nevin has not worked on email marketing-specific projects, but he is interested in exploring how AI can improve email campaigns and analytics." },
  { question: "what is nevin's experience with CRM", answer: "Nevin has not worked on CRM-specific projects, but he is interested in exploring how AI can optimize customer relationship management systems." },
  { question: "does nevin have experience with ERP", answer: "Nevin has not worked on ERP-specific projects, but he is interested in exploring how AI can enhance enterprise resource planning systems." },
  { question: "what is nevin's experience with SCM", answer: "Nevin has not worked on SCM-specific projects, but he is interested in exploring how AI can optimize supply chain management systems." },
  { question: "does nevin have experience with PLM", answer: "Nevin has not worked on PLM-specific projects, but he is interested in exploring how AI can improve product lifecycle management systems." },
  { question: "what is nevin's experience with HCM", answer: "Nevin has not worked on HCM-specific projects, but he is interested in exploring how AI can enhance human capital management systems." },
  { question: "does nevin have experience with LMS", answer: "Nevin has not worked on LMS-specific projects, but he is interested in exploring how AI can optimize learning management systems." },
  { question: "what is nevin's experience with CMS", answer: "Nevin has not worked on CMS-specific projects, but he is interested in exploring how AI can improve content management systems." },
  { question: "does nevin have experience with DAM", answer: "Nevin has not worked on DAM-specific projects, but he is interested in exploring how AI can enhance digital asset management systems." },
  { question: "what is nevin's experience with EAM", answer: "Nevin has not worked on EAM-specific projects, but he is interested in exploring how AI can optimize enterprise asset management systems." },
  { question: "does nevin have experience with ITSM", answer: "Nevin has not worked on ITSM-specific projects, but he is interested in exploring how AI can improve IT service management systems." },
  ...
  { question: "does nevin have experience with ITOM", answer: "Nevin has not worked on ITOM-specific projects, but he is interested in exploring how AI can enhance IT operations management systems." },
  { question: "what is nevin's experience with ITAM", answer: "Nevin has not worked on ITAM-specific projects, but he is interested in exploring how AI can optimize IT asset management systems." },
  { question: "does nevin have experience with ITSM", answer: "Nevin has not worked on ITSM-specific projects, but he is interested in exploring how AI can improve IT service management systems." },
  { question: "what is nevin's experience with ITOM", answer: "Nevin has not worked on ITOM-specific projects, but he is interested in exploring how AI can enhance IT operations management systems." },
  { question: "does nevin have experience with ITAM", answer: "Nevin has not worked on ITAM-specific projects, but he is interested in exploring how AI can optimize IT asset management systems." },
  { question: "what is nevin's experience with ITSM", answer: "Nevin has not worked on ITSM-specific projects, but he is interested in exploring how AI can improve IT service management systems." },
